      ...
      static async Percent(
        ...
        try {
            ...
            for (let i = 0; i < metadataAssets.length; i++) {
                ...
                if (nft.updateAuthorityAddress.toBase58() === PERCENT_AUTH) {
                    console.log(`🎯 Найдена NFT с updateAuthority ${PERCENT_AUTH}:`);
                    console.log(`✅ Mint: ${nft.address.toBase58()}`);
            ...
            console.log("❌ NFT с таким updateAuthority не найдены.", PERCENT_AUTH);
            return null;
